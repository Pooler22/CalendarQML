...
UBUNTU_TRANSLATION_DOMAIN="calendarqmlstable.username"
...
aptest.commands = bash $$PWD/CalendarQMLStable/tests/autopilot/run
aptest.depends  = sub-CalendarQMLStable

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/CalendarQMLStable/tests/unit 
unittest.depends  = sub-CalendarQMLStable
